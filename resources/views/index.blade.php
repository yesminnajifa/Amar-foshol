  ...
  <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-container">
        <h2>চাষাবাদই বিশ্বের ক্ষুধা দূর করার সেরা উপায়</h2>
        <p>কৃষির মাধ্যমে আমরা মানুষের খাদ্য চাহিদা পূরণ করতে পারি এবং পৃথিবীকে আরও টেকসই করতে পারি।</p>
      </div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-container">
        <h2>জৈব সবজি স্বাস্থ্যের জন্য উপকারী</h2>
        <p>প্রাকৃতিকভাবে উৎপাদিত জৈব সবজি শরীরের জন্য নিরাপদ, পুষ্টিকর এবং পরিবেশবান্ধব।</p>
      </div>
    </div><!-- End Carousel Item -->
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-container">
        <h2>প্রতিদিনই আমরা সরবরাহ করি তাজা কৃষিপণ্য</h2>
        <p>আমাদের কৃষকরা প্রতিদিন পরিশ্রম করে আপনাদের জন্য নিয়ে আসে বিশুদ্ধ ও তাজা ফসল।</p>
      </div>
    </div><!-- End Carousel Item -->
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-container">
        <h2>চাষাবাদ শুধু পেশা নয়, এটি একটি ভালোবাসা</h2>
        <p>কৃষকরা তাদের হৃদয়ের ভালোবাসা ও পরিশ্রম দিয়ে গড়ে তোলে আমাদের খাদ্যের ভিত্তি।</p>
      </div>
    </div><!-- End Carousel Item -->
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-container">
        <h2>সবার জন্য ভালো খাবার</h2>
        <p>আমরা বিশ্বাস করি, পুষ্টিকর ও নিরাপদ খাবার প্রত্যেক মানুষের মৌলিক অধিকার।</p>
      </div>
    </div><!-- End Carousel Item -->
    ...
    <section id="services" class="services section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>আমাদের সেবা</h2>
<p>আমরা প্রতিদিনই সরবরাহ করি তাজা ও মানসম্মত কৃষিপণ্য</p>
          ...
          <div class="row g-0">
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">🌱 রোপণ</h3>
                  <p>
                    গাছের চারা মাটিতে রোপণ করা কৃষির প্রথম ও গুরুত্বপূর্ণ ধাপ।
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">🌾 মালচিং</h3>
                  <p>
                    মাটির আর্দ্রতা ধরে রাখতে এবং আগাছা দমন করতে মালচিং একটি কার্যকর পদ্ধতি।
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">🚜 চাষ</h3>
                  <p>
                    চাষাবাদ হল মাটির প্রস্তুতি, বীজ রোপণ এবং ফসলের যত্ন নেওয়ার প্রক্রিয়া।
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">🌿 ঘাস কাটা</h3>
                  <p>
                    ঘাস কাটা হল মাঠের ঘাস এবং অন্যান্য উদ্ভিদ উপাদানগুলি কেটে ফেলার প্রক্রিয়া।
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">🥦 তাজা সবজি</h3>
                  <p>
                    প্রতিদিনের বাজারে সরাসরি কৃষকের কাছ থেকে সংগৃহীত পুষ্টিকর ও তাজা সবজি।
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">💧 সেচ বা পানি দেওয়া</h3>
                  <p>
                    সঠিক সময়ে এবং পরিমাণে সেচ দেওয়া ফসলের জন্য অত্যন্ত গুরুত্বপূর্ণ।
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">🛒 সবজি বিক্রয়</h3>
                  <p>
                    কৃষকদের উৎপাদিত তাজা সবজি সরাসরি বাজারে বিক্রি করা হয়।
                  </p>
                </div>
              </div>
            </div>
  ...
  <div class="row my-5">
    <div class="col-lg-12 d-flex align-items-start mb-4">
      ...
      <div>
        <h4 class="m-0 h5 text-white">গাছের জন্য বৃষ্টি প্রয়োজন</h4>
        <p class="text-white opacity-50">প্রাকৃতিক পরিবেশে গাছের বৃদ্ধি।</p>
      </div>
    </div>
    <div class="col-lg-12 d-flex align-items-start mb-4">
      <i class="bi bi-heart me-4 display-6"></i>
      <div>
        <h4 class="m-0 h5 text-white">অর্গানিক খাবার ভালোবাসা</h4>
        <p class="text-white opacity-50">সুস্থ এবং পরিচ্ছন্ন খাবার।</p>
      </div>
    </div>
    <div class="col-lg-12 d-flex align-items-start">
      <i class="bi bi-shop me-4 display-6"></i>
      <div>
        <h4 class="m-0 h5 text-white">সবজি বিক্রি</h4>
        <p class="text-white opacity-50">তাজা ও মানসম্পন্ন সবজি সরবরাহ।</p>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between align-items-center">
          ...
          <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="mb-4">
  আমরা উচ্চমানের অর্গানিক ফল ও সবজি এবং পেশাদার কৃষি পরিষেবা প্রদান করি। আমাদের দল টেকসই চাষাবাদ পদ্ধতি নিশ্চিত করে, যা ফসলের উৎপাদন বাড়ায় এবং মাটির স্বাস্থ্য বজায় রাখে।
</p>
<ul class="list-unstyled list-check">
  <li>প্রমাণিত অর্গানিক বীজ এবং গাছ</li>
  <li>আধুনিক সেচ ও চাষাবাদ পদ্ধতি</li>
  <li>স্থানীয় কৃষক ও সবজি বাজারকে সহায়তা</li>
</ul>
...
<section id="recent-posts" class="recent-posts section">
  ...
  <div class="container section-title" data-aos="fade-up">
    ...
    <p>আমাদের সাম্প্রতিক খবর এবং আপডেটগুলি</p>
  </div><!-- End Section Title -->
      ...
      <div class="col-xl-4 col-md-6">
        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="post-img position-relative overflow-hidden">
            ...
            <span class="post-date">ডিসেম্বর ১২</span>
          </div>

          <div class="post-content d-flex flex-column">

            <h3 class="post-title">কৃষিতে নতুন প্রযুক্তি এবং উন্নয়ন</h3>

            <div class="meta d-flex align-items-center">
              <div class="d-flex align-items-center">
                <i class="bi bi-person"></i> <span class="ps-2">জুলিয়া পার্কার</span>
              </div>
              <span class="px-3 text-black-50">/</span>
              <div class="d-flex align-items-center">
                <i class="bi bi-folder2"></i> <span class="ps-2">কৃষি প্রযুক্তি</span>
              </div>
            </div>

            <hr>

            <a href="blog-details.html" class="readmore stretched-link"><span>আরও পড়ুন</span><i class="bi bi-arrow-right"></i></a>
      ...
      <div class="col-xl-4 col-md-6">
        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="post-img position-relative overflow-hidden">
            ...
            <span class="post-date">জুলাই ১৭</span>
          </div>

          <div class="post-content d-flex flex-column">

            <h3 class="post-title">সাসটেইনেবল চাষাবাদ: টেকসই কৃষির গুরুত্ব</h3>

            <div class="meta d-flex align-items-center">
              <div class="d-flex align-items-center">
                <i class="bi bi-person"></i> <span class="ps-2">মারিও ডগলাস</span>
              </div>
              <span class="px-3 text-black-50">/</span>
              <div class="d-flex align-items-center">
                <i class="bi bi-folder2"></i> <span class="ps-2">পরিবেশ</span>
              </div>
            </div>
      ...
      <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
        <div class="post-item position-relative h-100">
          ...
          <div class="post-img position-relative overflow-hidden">
            ...
            <span class="post-date">সেপ্টেম্বর ০৫</span>
          </div>

          <div class="post-content d-flex flex-column">

            <h3 class="post-title">স্থানীয় কৃষি বাজার এবং অর্থনীতি</h3>

            <div class="meta d-flex align-items-center">
              <div class="d-flex align-items-center">
                <i class="bi bi-person"></i> <span class="ps-2">লিসা হান্টার</span>
              </div>
              <span class="px-3 text-black-50">/</span>
              <div class="d-flex align-items-center">
                <i class="bi bi-folder2"></i> <span class="ps-2">অর্থনীতি</span>
              </div>
            </div>
...
<p class="opacity-50">
  সর্বশেষ খবর, কৃষি টিপস এবং আপডেট সরাসরি আপনার মেইলে পেতে আমাদের নিউজলেটারে সাবস্ক্রাইব করুন।
</p>
